...
<head>
    ...
    <title>Ajout d'une nouvelle image pour l'habitat</title>
    <!-- Bootstrap 5.1 CSS -->
...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        try {
            ...
            // Ajouter l'image à l'habitat
            $habitat->addHabitatImage($_POST['id'], $_FILES['image_id']);
    ...
    ?>
    <div class="container">
        <h1>Ajouter une image pour l'habitat <?php echo htmlspecialchars($_GET['nom']); ?></h1>
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <button class="btn btn-primary mt10perso"><a class="lien"
                    href="detail_habitat.php?id=<?php echo htmlspecialchars($_GET['id']); ?>">Retour sur le détail de
                    l'habitat</a></button>
        </form>
    </div>
